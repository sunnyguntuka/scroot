...
| `calibration.schedule` | Managed calibration lifecycle | calibrate() fit + CalibrationResult | `src/scroot/calibrate.py:123` |
| `drift.continuous` | Continuous drift monitoring (Ampulla) | regression_check() point-in-time CI gate | `src/scroot/drift.py:128` |
...
| `runtime.managed` | Managed scoring runtime | runtime.run() local air-gapped scoring + preflight() | `src/scroot/runtime/__init__.py:86` |
